...
class Controls:
  ...
  def state_control(self, CS):
    ...
    MIN_LATERAL_CONTROL_SPEED = 1.0 # 시속 나누기 3.6으로 초속계산 1.1이면 시속 4키로 즉 1보다 작으면 3.6키로 미만이다..
    ...
    if not self.joystick_mode:
      ...
      actuators.accel = self.LoC.update(CC.longActive and CS.cruiseState.enabledAcc, CS, long_plan, pid_accel_limits, t_since_plan, self.sm['radarState'])
